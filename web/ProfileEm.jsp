    ...
    <head>
        ...
        <style>
            ...
            .btn-outline-secondary:hover {
                 /* Màu nền nút outline secondary khi hover */
                                            ...
                                            <div class="col-md-6 text-center mb-5">
                                                ...
                                                <div class="mt-3">
                                                    <div class="mb-5 row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input type="text" readonly class="form-control-plaintext text-center fs-5" id="userCus" value="${profile.getUserEmployee()}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="offset-sm-3 col-sm-6 ">
                                                        ...
                                                        <a  href="UpdateProfile?name=${profile.getUserEmployee()}"><button class="btn btn-outline-success">Edit Profile</button></a>
                                                    </div>
                                                </div>
                                            </div>
