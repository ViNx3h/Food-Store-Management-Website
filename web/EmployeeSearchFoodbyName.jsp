<%-- 
    Document   : EmployeeSearchbyName
    Created on : Jun 14, 2024, 7:59:35 PM
    Author     : ADMIN
--%>
                        ...
                        <tbody>
                            ...
                            <c:forEach var="c" items="${requestScope.list}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="UpdateFood.jsp?id=${c.idFood}" type="button" class="btn btn-outline-warning btn-sm btn-custom">Update</a>
