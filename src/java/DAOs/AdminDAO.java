...
public class AdminDAO {
    ...
    public String getEmail(String username) throws ClassNotFoundException {
        ...
        try {
            conn = DBcontext.DBConnection.connect();
            PreparedStatement ps = conn.prepareStatement("Select email from Admin Where userAdmin = ?");
    ...
    public void ChangePassAdmin(String newPass, String username) {
        String sql = "update Admin set password=? where userAdmin=?";
        try {
            conn = DBcontext.DBConnection.connect();
            ps = conn.prepareStatement(sql);
