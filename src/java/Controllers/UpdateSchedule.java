...
//        processRequest(request, response);
        ...
        if (cList != null) {
            ...
            if (role.equals("admin")) {
                ...
                WorkingSchedule st = dao.findEmployee(id);
                request.setAttribute("data", st);
                request.getRequestDispatcher("UpdateSchedulebyAdmin.jsp").forward(request, response);
            }
            ...
            if (role.equals("employee")) {
                ...
                WorkingSchedule st = dao.findEmployee(id);
                request.setAttribute("data", st);
                request.getRequestDispatcher("UpdateSchedulebyEm.jsp").forward(request, response);
            }
        }
    }
...
//        processRequest(request, response);
        ...
        if (cList != null) {
            ...
            if (role.equals("admin")) {
                WorkingSchedulesDAO dao = new WorkingSchedulesDAO();
                WorkingSchedule update = new WorkingSchedule(id, username, fullName, day, time);
                dao.updateWorkingSchedule(update);
                response.sendRedirect("ViewSchedulebyAdmin.jsp");
            }
            if (role.equals("employee")) {
                WorkingSchedulesDAO dao = new WorkingSchedulesDAO();
                WorkingSchedule update = new WorkingSchedule(id, username, fullName, day, time);
                dao.updateWorkingSchedulebyEm(update);
