                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="button-container">
                                                ...
                                                <a href="DeleteSchedule?id=${c.getId()}" class="btn btn-outline-danger btn-sm button-same-size" onclick="return confirm('Are you sure you want to delete this Category?');">Delete</a>
                                            </div>
                                        </td>
                                    </tr>
                                </c:forEach>
