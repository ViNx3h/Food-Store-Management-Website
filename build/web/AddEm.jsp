        ...
        <div class="container mb-5">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    ...
                    <%
                        session.removeAttribute("error"); // Remove the attribute to avoid showing the error again
                    }
                    %>
                    ...
                    <form action="AddEm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password"  class="form-control" id="password" name="password" pattern=".{6,12}" placeholder="Example: Nguyenvana123"
                                   required oninvalid="this.setCustomValidity('Password cannot be empty and must be 6 to 12 characters long.')" oninput="this.setCustomValidity('')">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="" name="address" placeholder="Example: Vinh Long" required>
                    ...
                    <a href="Employees.jsp" class="btn btn-secondary mt-3"><i class="fas fa-arrow-left"></i> Back</a>
                </div>
            </div>
        </div>
