...
<html>
    <head>
        ...
        <style>
            ...
            .btn-custom {
                margin-bottom: 10px; /* Điều chỉnh khoảng cách giữa các nút */
            }
                                    ...
                                    <c:forEach var="c" items="${requestScope.list}">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <br>
                                                <a href="DeleteFood?id=${c.idFood}" onclick="return confirmDeleteProduct('${c.idFood}')" type="button" class="btn btn-outline-danger btn-sm btn-custom ">Delete</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
