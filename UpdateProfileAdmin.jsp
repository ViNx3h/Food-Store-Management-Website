<%-- 
    ...
    Created on : 19-Jun-2024, 20:01:54
    Author     : lecon
--%>
        ...
        <div class="container mt-5">
            <div class="row justify-content-center">
                <div class="col-md-8">
                        ...
                        <div class="card-body">
                            <form action="UpdateProfile" method="post" enctype="multipart/form-data">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" readonly class="form-control-plaintext" id="username" name="username" value="${profile.getUserAdmin()}">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" id="gender" name="gender">
                                            <option value="true" ${profile.isGender() ? 'selected' : ''}>Male</option>
                                            <option value="false" ${!profile.isGender() ? 'selected' : ''}>Female</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                    ...
                    <div class="text-end">
                        <a class="btn btn-secondary" href="ProfileAdmin.jsp">Back</a>
