...
<html>
    ...
    <body>     
                ...
                <div class="col-md-8">
                    <div class="card shadow-sm">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" readonly class="form-control-plaintext" id="userCus" value="${profile.getUserEmployee()}">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                        ...
                        <div class="card-footer text-end">
                            <a class="btn btn-secondary" href="DashBoardEmployee.jsp">Back</a>
                            <a class="btn btn-primary" href="UpdateProfile?name=${profile.getUserEmployee()}">Update</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <form action="ChangePassword" method="post">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="username" readonly value="${profile.getUserEmployee()}">
                            </div>
                            <div class="mb-3">
        ...
        <!-- Include the Bootstrap JavaScript bundle from a CDN (Content Delivery Network) -->
