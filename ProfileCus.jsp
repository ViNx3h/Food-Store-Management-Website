            ...
            <div class="col-md-8">
                <div class="card shadow-sm">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" readonly class="form-control-plaintext" id="userCus" value="${profile.getUserCus()}">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                    ...
                    <div class="card-footer text-end">
                        ...
                        <a class="btn btn-primary" href="UpdateProfile?name=${profile.getUserCus()}">Update</a>
                    </div>
                </div>
            </div>
        </div>
